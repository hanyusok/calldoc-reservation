...
export default function MartClinicPage() {
    ...
    const services = [
        { icon: Baby, label: t('services.pediatrics'), color: "text-rose-500", bg: "bg-rose-50" },
    ...
    return (
        <div className="min-h-screen bg-white">
            {/* Hero Section */}
            <section className="relative overflow-hidden bg-gradient-to-br from-rose-50 via-white to-orange-50 py-20 lg:py-32">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
                    <div className="inline-flex items-center rounded-full bg-rose-100 px-3 py-1 text-sm font-medium text-rose-800 mb-8">
                    ...
                    <div className="flex justify-center gap-4">
                        <Link
                            href="/dashboard"
                            className="inline-flex items-center justify-center px-8 py-4 border border-transparent text-lg font-medium rounded-full text-white bg-rose-500 hover:bg-rose-600 transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-1"
                        >
                            {t('hero.cta')}
                        </Link>
                    </div>
                ...
                <div className="absolute top-0 left-0 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-rose-200 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob"></div>
            ...
            <section className="py-20 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        <h2 className="text-base font-semibold text-rose-600 tracking-wide uppercase">{t('services.title')}</h2>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-8">
                        {services.map((service, index) => {
                            ...
                            return (
                                <div key={index} className="group relative bg-white p-6 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-all duration-300 hover:border-rose-100 flex flex-col items-center text-center">
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        ...
                        <div className="bg-slate-900 text-white p-8 sm:p-12 rounded-3xl relative overflow-hidden">
                            <div className="relative z-10">
                                <MapPin className="w-10 h-10 text-rose-400 mb-6" />
                                ...
                                <div className="mt-8 pt-8 border-t border-slate-700">
                                    <div className="flex items-center text-rose-400 font-semibold text-lg">
                        ...
                        <div className="bg-rose-50 p-8 sm:p-12 rounded-3xl text-slate-900 border border-rose-100">
                            <Clock className="w-10 h-10 text-rose-600 mb-6" />
                            <h3 className="text-2xl font-bold mb-6">{t('info.hoursTitle')}</h3>
                            <ul className="space-y-4">
                                <li className="flex justify-between items-center border-b border-rose-200 pb-2">
            ...
            <section className="py-20 bg-rose-500 text-white text-center">
                <div className="max-w-4xl mx-auto px-4">
                    ...
                    <Link
                        href="/dashboard"
                        className="inline-block bg-white text-rose-600 px-8 py-4 rounded-full text-lg font-bold shadow-lg hover:bg-gray-100 transition-colors"
                    >
                        {t('hero.cta')}
                    </Link>
                </div>
